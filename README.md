...
For broader documentation on Windmill's MCP integration (including Claude Desktop and Codex setup), see [help.gowindmill.com/features/mcp](https://help.gowindmill.com/features/mcp).
